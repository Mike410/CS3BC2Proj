  ...
  <nav id="topNav" class="navbar navbar-default navbar-fixed-top">
    ...
    <div id="products" class="row list-group">
        <div class="item  col-xs-4 col-lg-4">
            <div class="thumbnail">
                <img class="group list-group-image" src="SpecificPants1.jpg" alt="" />
                <div class="caption">
                    <h4 class="group inner list-group-item-heading">
                        Turquoise and Orange Harem Trousers</h4>
                    <p class="group inner list-group-item-text">
                        These pants have a traditional turquoise and orange print with elasticated ankles for a modern twist.</p>
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-6">
                            <a class="btn btn-success" href="productPage.php">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
